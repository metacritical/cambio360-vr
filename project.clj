(defproject cambio-360 "0.1.0"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "cambio-360.core/on-js-reload"
                ...
                :compiler {:main cambio-360.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/cambio_360.js"
